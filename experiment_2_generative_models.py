...
# 🧪 Experiment 2: Generative Models 📸
...
Hello, all, and welcome to experiment 2! 🎉

This time around,  you'll be exploring generative models for creating images 📸 As a reminder, feel free to check out [this quick Colab tutorial](https://www.youtube.com/watch?v=inN8seMm7UI) if you're encountering any ititial hiccups, and please post to [#experiment-help on Slack](https://app.slack.com/client/T02C7FPG736/C02E8Q6MPQS/thread/C02F1TW047L-1632710063.018600) if you're in need of any assistance.

Let's get into it! 🤖 This week's experiment is all about generative models. There are two ways to train a generative "decoder" of images: Variational Autoencoder (VAEs) and a Generative Adversarial Networks (GANs). We'll dive deeper into these concepts in the third seminar, but here's your chance to get familiar with them hands-on as an introduction. 
...
This procee, for example, lets us add eyeglasses to a face, or change hair color, *etc*. 😎 💇 👁️
...
- Learning how to use pretrained models that you can find online 🌐
...
Cropped it with FFMPEG (e.g. `ffmpeg -i DOGS\ 4K_Cute\ DOGS\ \&\ PUPPIES\ in\ 4K\ Ultra\ HD\ 🐶-BdIiS3vURWA.webm -ss 00:02:24 -to 00:02:28 -filter:v "scale=1000:-1,crop=256:256:320:170" -an -y dog_crop.mp4`)
